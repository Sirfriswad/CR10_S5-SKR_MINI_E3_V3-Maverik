 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        180 // Seconds, Maverik
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                180 // Seconds, Maverik
 ...
 */
#define USE_CONTROLLER_FAN // Maverik FAN2
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN FAN1_PIN           // Set a custom pin for the controller fan, Maverik
 ...
 */
#define FAN_MIN_PWM 50 // Maverik CR-10 S5 Fan
...
#define HOMING_BUMP_MM      { 10, 10, 5 }      // (linear=mm, rotational=°) Backoff from endstops after first bump, Maverik
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }        // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 25, 25, 10 }  // (linear=mm, rotational=°) Backoff from endstops after homing, Maverik

#define QUICK_HOME                            // If G28 contains XY do a diagonal move first, Maverik
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 500 // Maverik BLtouch
   ...
   */
  #define BLTOUCH_HS_MODE true // Maverik BLtouch
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define LCD_INFO_MENU                      // Maverik CR-10 S5 LCD
  #if ENABLED(LCD_INFO_MENU)
    //#define LCD_PRINTER_INFO_IS_BOOTSCREEN // Show bootscreen(s) instead of Printer Info pages
  #endif

  // BACK menu items keep the highlight at the top
  #define TURBO_BACK_MENU_ITEM  // Maverik CR-10 S5 UI
  ...
  #define STATUS_MESSAGE_SCROLLING        // Maverik CR-10 S5 LCD
...
// LCD Print Progress options
  ...
  #define BROWSE_MEDIA_ON_INSERT            // Open the file browser when media is inserted, Maverik SDcard

  #define MEDIA_MENU_AT_TOP                 // Force the media menu to be listed on the top of the main menu, Maverik SDcard UI
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY           // Maverik CR-10 S5
   ...
   */
  #define SDCARD_SORT_ALPHA           // Maverik UI
  ...
  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu, Maverik
 ...
 */
  ...
  #define MARLIN_BRICKOUT           // Maverik
  //#define MARLIN_INVADERS
  #define MARLIN_SNAKE              // Maverik
  #define GAMES_EASTER_EGG          // Add extra blank lines above the "Games" sub-menu, Maverik
 ...
 */
#define BABYSTEPPING                        // Maverik CR-10 S5
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  #define BABYSTEP_WITHOUT_HOMING           // Maverik CR-10 S5
  #define BABYSTEP_ALWAYS_AVAILABLE         // Allow babystepping at all times (not just during movement). Maverik
  //#define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way
  #define BABYSTEP_MILLIMETER_UNITS         // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps, Maverik
  #define BABYSTEP_MULTIPLICATOR_Z  0.05    // (steps or mm) Steps or millimeter distance for each Z babystep, Maverik
  #define BABYSTEP_MULTIPLICATOR_XY 0.05    // (steps or mm) Steps or millimeter distance for each XY babystep, Maverik

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // Double-click on the Status Screen for Z Babystepping. Maverik
  ...
  #define BABYSTEP_DISPLAY_TOTAL            // Display total babysteps since last G28, Maverik

  #define BABYSTEP_ZPROBE_OFFSET            // Combine M851 Z and Babystepping, Maverik
 ...
 */
#define LIN_ADVANCE             // Maverik Extruder
 ...
 */
#define G29_RETRY_AND_RECOVER // Maverik BLtouch
 ...
 */
#define EMERGENCY_PARSER // Maverik
 ...
 */
#define ADVANCED_PAUSE_FEATURE // Maverik CR-10 S5 Filament Sensor
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         60  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH           10  // (mm) Initial retract. Maverik
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     41  // (mm/s) Unload filament feedrate. This can be pretty fast. Maverik
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      120  // (mm) The length of filament for a complete unload. Maverik
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  41  // (mm/s) Load filament feedrate. This can be pretty fast. Maverik
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    95  // (mm) Load length of filament, from extruder gear to nozzle. Maverik
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        3  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
  #define ADVANCED_PAUSE_PURGE_LENGTH        150  // (mm) Length to extrude after loading. Maverik
  ...
  #define PARK_HEAD_ON_PAUSE                      // Park the nozzle during pause and filament change. Maverik
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       580        // (mA) RMS current. Multiply by 1.414 for peak current. Maverik
   ...
   */
  #define HYBRID_THRESHOLD  // Maverik CR-10 S5 Motors

  #define X_HYBRID_THRESHOLD     100  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     100
  #define Y2_HYBRID_THRESHOLD    100
  #define Z_HYBRID_THRESHOLD      15  // Maverik CR-10 S5 Motors
  #define Z2_HYBRID_THRESHOLD     15  // Maverik CR-10 S5 Motors
  ...
  #define DIAG_JUMPERS_REMOVED // Maverik, defined when SENSORLESS_HOMING is disabled in order to prevent compile warning.
   ...
   */
  #define SQUARE_WAVE_STEPPING  // Maverik Motors
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT // Maverik
#endif
 ...
 */
#define HOST_ACTION_COMMANDS              // Maverik
  ...
  #endif
  //#define HOST_START_MENU_ITEM            // Add a menu item that tells the host to start, Maverik
  //#define HOST_SHUTDOWN_MENU_ITEM         // Add a menu item that tells the host to shut down, Maverik
#endif
